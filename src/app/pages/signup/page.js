...
const roleDetails = {
  freelancer: {
    ...
    required: [
      ...
      { name: "workspace", label: "Workspace Name", type: "text", placeholder: "ex: My Freelance Work" }
    ],
    optional: [
  ...
  client: {
    ...
    optional: [
      ...
      { name: "clientNotes", label: "Notes", type: "text", placeholder: "Billing address, contract ID" },
    ]
  },
  team: {
    ...
    optional: [
      { name: "role", label: "Role", type: "select", options: ["User", "Manager"] },
      { name: "billableRate", label: "Billable Rate", type: "number", placeholder: "₹/hr" }
    ]
  },
  admin: {
    ...
    optional: [
      ...
      { name: "teamEmails", label: "Team Members' Emails", type: "text", placeholder: "Comma separated" }
    ]
  }
};
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-green-50 flex flex-col items-center justify-center px-4 py-10">
      <div className="w-full max-w-lg bg-white rounded-2xl shadow-xl p-8">
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-600">Choose your role and fill in your details</p>
          ...
          {step === 1 ? (
            <div>
              ...
              <div className="text-center text-gray-600 mt-6">
                ...
                <a href="/pages/login" className="text-blue-700 font-semibold hover:underline">
                  Login
                </a>
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center mb-6">
                ...
                <span className="font-medium text-blue-800">{details.label}</span>
              </div>
              {success ? (
                      ...
                      <div key={input.name} className="space-y-2">
                        ...
                        {input.type === "select" ? (
                          ...
                          <input
                            ...
                            name={input.name}
                            required
                            value={input.type === "file" ? undefined : form[input.name] || ""}
                            onChange={handleChange}
                            className="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
